...
//! ```
//! use study::commands;
//! use study::{Data, LocalizedString, Menu, MenuItem, SysMods};
//!
...
//!                 // study handles the QUIT_APP command automatically
...
///
/// On the study-shell side, the id is represented as a u32.
