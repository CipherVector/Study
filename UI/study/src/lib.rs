...
//!
//! Druid is built on top of [`study-shell`], which implements all of the
...
//! an application. Below [`study-shell`] is [`piet`], which is a cross-platform
...
//!
//! For more information you should read the [study book].
//!
//! # Examples
//!
//! For many more examples, see [`study/examples`].
//!
//! ```no_run
//! use study::widget::{Align, Flex, Label, TextBox};
//! use study::{AppLauncher, Data, Env, Lens, LocalizedString, Widget, WindowDesc, WidgetExt};
//!
...
//! [`study-shell`]: https://docs.rs/study-shell
//! [`piet`]: https://docs.rs/piet
//! [`study/examples`]: https://github.com/linebender/study/tree/v0.7.0/study/examples
//! [study book]: https://linebender.org/study/
...
#![doc(
    html_logo_url = "https://raw.githubusercontent.com/linebender/study/screenshots/images/doc_logo.png"
)]

// Allows to use macros from study_derive in this crate
extern crate self as study;
pub use study_derive::Lens;

use study_shell as shell;
#[doc(inline)]
pub use study_shell::{kurbo, piet};

// the im crate provides immutable data structures that play well with study
#[cfg(feature = "im")]
#[doc(inline)]
pub use im;
...
#[deprecated(since = "0.8.0", note = "import from study::text module instead")]
