...
pub const REPLACE_CHILD: Selector = Selector::new("study-test.replace-child");
...
///
/// ```
/// # use study::widget::Label;
/// # use study::{WidgetExt, LifeCycle};
/// use study::tests::helpers::{Recording, Record, TestWidgetExt};
/// use study::tests::harness::Harness;
