...
/// # Options
///
/// To experiment with these options, see the `flex` example in `study/examples`.
///
...
///
/// ```
/// use study::widget::{Flex, FlexParams, Label, Slider, CrossAxisAlignment};
///
/// let my_row = Flex::row()
...
/// # Examples
/// ```
/// use study::widget::{FlexParams, Label, CrossAxisAlignment};
///
/// let mut row = study::widget::Flex::<()>::row();
