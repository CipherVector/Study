...
//! This is an example of how you would implement the game of life with study.
//! This example doesnt showcase anything specific in study.
...
use study::widget::{Button, Flex, Label, Slider};
use study::{
