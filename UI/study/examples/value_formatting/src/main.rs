...
use study::widget::{prelude::*, Flex, Label, TextBox};
use study::{AppLauncher, Data, Lens, WidgetExt, WidgetId, WindowDesc};
...
fn dollar_validation_scope() -> impl Widget<AppData> {
    ...
    Flex::column()
        .cross_axis_alignment(study::widget::CrossAxisAlignment::End)
        .with_child(
            Flex::row()
                .cross_axis_alignment(study::widget::CrossAxisAlignment::Baseline)
...
fn ui_builder() -> impl Widget<AppData> {
    Flex::column()
        .with_child(
            widgets::explainer()
                .padding(10.0)
                .border(study::theme::BORDER_DARK, 4.0)
                .rounded(10.0)
                .padding(10.0),
        )
        .with_default_spacer()
