...
//! This example shows a how a single-line text field might be implemented for study-shell.
...
use study_shell::kurbo::Size;
use study_shell::piet::{
...
use study_shell::kurbo::{Point, Rect};
