...
impl Application {
    pub fn new() -> Result<Application, Error> {
        ...
        let gtk_app = GtkApplication::new(
            Some("com.github.linebender.study"),
            // TODO we set this to avoid connecting to an existing running instance
            // of "com.github.linebender.study" after which we would never receive
            // the "Activate application" below. See pull request study#384
