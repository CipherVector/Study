...
impl WindowHandle {
    ...
    /// `study-shell`, and the [`WinHandler::open_file`] method will be called when the dialog is
    /// closed.
    ...
    ///
    /// This won't block immediately; the file dialog will be shown whenever control returns to
    /// `study-shell`, and the [`WinHandler::save_as`] method will be called when the dialog is
    /// closed.
