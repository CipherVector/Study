...
//! 4. If `key_down` returned `false`, study-shell forwards the key event to the
...
//! ## Supported Platforms
//!
//! Currently, `study-shell` text input is fully implemented on macOS. Our goal
//! is to have full support for all study-shell targets, but for now,
