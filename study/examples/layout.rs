...
use study::widget::{AspectRatioBox, Button, Flex, Label, LineBreaking};
use study::{AppLauncher, Color, Widget, WidgetExt, WindowDesc};
...
fn build_app() -> impl Widget<u32> {
    ...
    // This method asks study to draw colored rectangles around our widgets,
