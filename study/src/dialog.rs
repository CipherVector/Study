...
//!
//! This is a wrapper around [`study_shell::FileDialogOptions`] with a few extra study specifics.
//! As such, many of the docs are copied from `study_shell`, and should be kept in sync.

use std::path::PathBuf;

use study_shell::FileDialogOptions as ShellOptions;
...
/// This is being tracked in [study#998].*
///
...
/// [study#998]: https://github.com/xi-editor/study/issues/998
