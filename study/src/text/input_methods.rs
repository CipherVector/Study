...
//!
//! Most IME-related code is in study-shell; these are helper types used
//! exclusively in study.
...
/// the widget tree changes, study will call [`is_alive`] on each registered
