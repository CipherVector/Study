...
impl EventCtx<'_, '_> {
    ...
    ///
    /// ```
    /// # use study::{Event, EventCtx, Selector};
    /// const IMPORTANT_EVENT: Selector<String> = Selector::new("study-example.important-event");
    ///
    ...
    pub fn set_active(&mut self, active: bool) {
        ...
        // TODO: plumb mouse grab through to platform (through study-shell)
    }
...
impl PaintCtx<'_, '_, '_> {
    ...
    ///
    /// ```
    /// # use study::{Env, PaintCtx, RenderContext, theme};
    /// # struct T;
    /// # impl T {
