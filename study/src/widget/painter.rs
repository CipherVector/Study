...
///
/// ```
/// use study::{Env, PaintCtx,Rect, RenderContext};
/// use study::widget::Painter;
/// # const ENABLED_BG_COLOR: study::Key<study::Color> = study::Key::new("fake key");
/// # const DISABLED_BG_COLOR: study::Key<study::Color> = study::Key::new("fake key 2");
///
...
///
/// ```
/// use study::{Color, Env, PaintCtx,Rect, RenderContext};
/// use study::widget::Painter;
///
...
///     ctx.stroke(rounded, &env.get(study::theme::PRIMARY_DARK), STROKE_WIDTH);
/// });
/// ```
///
