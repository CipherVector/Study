...
// Localization looks for string files in study/resources, but this path is hardcoded;
// it will only work if you're running an example from the study/ directory.
