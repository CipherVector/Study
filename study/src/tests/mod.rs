...
#[test]
fn take_focus() {
    const TAKE_FOCUS: Selector = Selector::new("study-tests.take-focus");
...
fn focus_changed() {
    const TAKE_FOCUS: Selector = Selector::new("study-tests.take-focus");
    const ALL_TAKE_FOCUS_BEFORE: Selector = Selector::new("study-tests.take-focus-before");
    const ALL_TAKE_FOCUS_AFTER: Selector = Selector::new("study-tests.take-focus-after");
...
#[test]
fn simple_disable() {
    const CHANGE_DISABLED: Selector<bool> = Selector::new("study-tests.change-disabled");
...
fn resign_focus_on_disable() {
    const CHANGE_DISABLED: Selector<bool> = Selector::new("study-tests.change-disabled-disable");
    const REQUEST_FOCUS: Selector<()> = Selector::new("study-tests.change-disabled-focus");
...
fn disable_tree() {
    const MULTI_CHANGE_DISABLED: Selector<HashMap<WidgetId, bool>> =
        Selector::new("study-tests.multi-change-disabled");
...
fn request_update() {
    const REQUEST_UPDATE: Selector = Selector::new("study-tests.request_update");
...
fn notifications() {
    const NOTIFICATION: Selector = Selector::new("study-tests.some-notification");
