...
///
/// ```
///# use study::{Key, Color, WindowDesc, AppLauncher, widget::Label};
...
impl Env {
    ...
    pub(crate) const DEBUG_PAINT: Key<bool> = Key::new("org.linebender.study.built-in.debug-paint");
    ...
    pub(crate) const DEBUG_WIDGET_ID: Key<bool> =
        Key::new("org.linebender.study.built-in.debug-widget-id");
    ...
    pub const DEBUG_WIDGET: Key<bool> = Key::new("org.linebender.study.built-in.debug-widget");
    ...
    /// resources.
    ///
    /// This always exists on the base `Env` configured by study.
    ///
