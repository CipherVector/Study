...
///
/// `WidgetPod` will translate internal study events to regular events,
        ...
        for notification in notifications.drain(..) {
            ...
            if notification.source() != self_id {
                ...
                if inner_ctx.is_handled {
                    ...
                    // could be unchecked but we avoid unsafe in study :shrug:
                    unreachable!()
                }
            } else {
...
mod tests {
    ...
    fn send_notifications() {
        ...
        let notification = Command::new(study::command::sys::CLOSE_WINDOW, (), Target::Global);
