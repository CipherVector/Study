...
use study_shell::{Clipboard, KeyEvent, TimerToken};
...
/// Internal events used by study inside [`WidgetPod`].
///
...
pub enum LifeCycle {
    ...
    HotChanged(bool),
    /// This is called when the widget-tree changes and study wants to rebuild the
    /// Focus-chain.
    ///
    ...
    FocusChanged(bool),
    /// Internal study lifecycle event.
    ///
    /// This should always be passed down to descendant [`WidgetPod`]s.
    ///
    /// [`WidgetPod`]: struct.WidgetPod.html
...
/// Internal lifecycle events used by study inside [`WidgetPod`].
///
